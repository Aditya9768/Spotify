...
async function displayAlbums(){
    ...
    let array = Array.from(anchors)
        ...
        if (e.href.includes("/songs") && !e.href.includes(".htaccess")) {
            ...
            //Get the mete dada of the folder
            ...
            <div class="play">
              <svg xmlns="http://www.w3.org/2000/svg" width="62" height="62">
                <circle cx="31" cy="31" r="27" fill="#1ed760"/>
                <svg x="15%" y="15%" width="70%" height="70%" viewBox="0 0 24 24" fill="#000" stroke="#000" stroke-linecap="round" stroke-linejoin="round">
